...
const framework = (function () {
  ...
  return {
    ...
    createModule<S = any, M = any, G = any, A = any>(
       ...
       *
       * @property {Function} createModel - Creates a new entity instance within the module.
       ...
       *
       * @property {Function} getModelById - Retrieves an entity by its unique identifier.
       ...
       *
       * @property {Function} removeModel - Removes an entity from the module by its id.
